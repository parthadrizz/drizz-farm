    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-medium text-gray-300">{instance?.device_name || id}</span>
        ...
        <div className="flex gap-1.5">
          <button onClick={() => sendInput('back')} className="px-2 py-1 bg-gray-800 rounded text-[10px] hover:bg-gray-700 transition">Back</button>
          <button onClick={() => sendInput('home')} className="px-2 py-1 bg-gray-800 rounded text-[10px] hover:bg-gray-700 transition">Home</button>
          <button onClick={() => sendInput('recent')} className="px-2 py-1 bg-gray-800 rounded text-[10px] hover:bg-gray-700 transition">Recent</button>
        </div>
      </div>
      ...
      {instance && (
        <div className="flex justify-center">
          <div className="text-[10px] text-gray-600 space-x-3">
            <span>{instance.serial}</span>
            <span>port:{instance.connection.adb_port}</span>
